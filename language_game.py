...
async def main():
    ...
    italian_word = ["che tempo fa", "it's sunny", "noi dobbiamo", "tu puoi", "stanotte", "affollato", "sono stanca", "prezzo","cucchiaio", "ciotola", "il buio", "in fuga da", "uno starnuto"]
    answer = ["what's the weather like", "E soleggiato", "we must", "you can", "tonight", "crowded", "I'm tired", "price", "spoon", "bowl", "the dark", "on the run from", "a sneeze"]
    current_index = 0
    phase = 0
    end_time = 0
    score = 0
    ...
    while running:
        ...
        if phase == 0 and current_index < len(italian_word):
            ...
            end_surface = base_font.render("Done!", True, (255, 255, 255))
            screen.blit(end_surface, (350, 200))
